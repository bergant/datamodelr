...
```{r posgres_focus_render, eval=FALSE}
focus <- list(tables = c(
    "customer",
    "payment", 
    "rental",
...
```{r postgres_segments_render, eval=eval_render}
...
```{r colors_render, eval=eval_render}
display <- list(
...
```{r color_scheme, echo=FALSE, fig.height=2, eval=FALSE}
...
```{r custom_colors, eval=eval_render}
...
```{r dot_attributes, eval=eval_render}
